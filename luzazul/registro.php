...
<div class="form-group d-flex flex-column">
    ...
    <input type="text" class="form-control d-flex" name = "nombre" id="exampleInputEmail1">
  ...
  <div class="form-group d-flex flex-column">
    ...
    <input type="password" class="form-control" name = "contraseñaRep" id="exampleInputPassword1">
