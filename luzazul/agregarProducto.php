...
<body> 
    ...
    <section class = "col- 12 col-md-12">
        ...
        <form  action = "agregarProducto.php" method="POST" class = "_form_login col-12 col-md-4 offset-md-4 mt-5 _form_login d-flex flex-column  ">
            ...
            <div class="form-group">
                ...
                <select name="categoria" class="form-control" id="exampleFormControlSelect1">
                    ...
                    <option value="2">Jarros termicos</option>
                    <option value="3">Mate listo</option>
